...
{
%>
<h3 class="alert alert-success" style="text-align:center;font-size:20px" role="alert">Product added successfully!</h3>
<%} %>
<%
if("exist".equals(msg))
{
%>
<h3 class="alert alert-success" style="text-align:center;font-size:20px" role="alert">Product already exist in you cart! Quantity  increased!</h3>
<%} %>
<%
if("invalid".equals(msg))
{
%>
<h3 class="alert alert-danger" style="text-align:center;font-size:20px" role="alert">Something went wrong! Try Again!</h3>
<%} %>
	<div>
